---
name: impeccable
description: "Design, redesign, audit or polish a frontend interface: websites, dashboards, product UI, components, forms, onboarding, empty states. Covers UX review, visual hierarchy, accessibility, typography, spacing, color, motion, and design tokens. Not for backend work."
version: 3.8.0
user-invocable: true
