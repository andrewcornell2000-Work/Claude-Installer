---
name: supabase
description: "Any Supabase task. Database, Auth, Edge Functions, Realtime, Storage, Vectors, Cron, Queues; supabase-js and @supabase/ssr in Next.js, React, SvelteKit, Astro, Remix; RLS, JWT and session bugs; CLI, MCP, migrations, schema changes."
metadata:
  author: supabase
  version: "0.1.2"
---
